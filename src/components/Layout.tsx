      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
          ...
          <Link to="/" className="relative z-[120] flex items-center gap-3">
            <img src="/HaNeul_logo.png" alt="HaNeul Logo" className="h-10 md:h-14 object-contain" />
        ...
        {mobileMenuOpen && (
          ...
          >
            ...
            <div className="absolute inset-0 opacity-[0.03] pointer-events-none flex items-center justify-center">
              <img src="/HaNeul_logo.png" alt="" className="w-4/5 object-contain" />
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-12 flex flex-col md:flex-row justify-between items-start gap-8 md:gap-12">
          <div className="md:w-1/3">
            <div className="flex items-center gap-3 md:gap-4 mb-4">
              <img src="/HaNeul_logo(2).png" alt="HaNeul Logo" className="h-10 md:h-16 lg:h-24 object-contain" />
